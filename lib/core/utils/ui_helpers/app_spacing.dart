...
class AppSpacing {
  ...
  static Widget get verticalSpaceVeryLarge => SizedBox(height: veryLargePadding);
  ...
  static Widget horizontalSpacePercentage(BuildContext context, double percentage) {
    return SizedBox(width: MediaQuery.of(context).size.width * percentage);
  }

  // Dynamic spacing based on screen height
  static Widget verticalSpacePercentage(BuildContext context, double percentage) {
    return SizedBox(height: MediaQuery.of(context).size.height * percentage);
  }
  /// Search Bar Padding
  static var searchBarPadding = const EdgeInsets.symmetric(horizontal: 12.0, vertical: 14.0);
